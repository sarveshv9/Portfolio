                            ...
                            {isRouterLink(item.href) ? (
                                ...
                                <a
                                    ...
                                    onClick={(e) => {
                                        ...
                                        // setIsMobileMenuOpen(false) is handled in handleLinkClick if it's an anchor, 
                                        // but for external links we still want to close it? 
                                        // standard behavior: external links navigate away so it matters less, 
                                        // but if it opens new tab, menu stays open. 
                                        // Let's just keep the original logic plus our handler.
                                        if (!isAnchorLink(item.href)) setIsMobileMenuOpen(false);
                                    }}
                                >
                                    {item.label}
                                </a>
